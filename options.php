 ...
 *
 * If you are making your theme translatable, you should replace 'lunt'
...
function optionsframework_options() {
	...
	$options[] = array(
		'name' => __('Header Meta', 'lunt'),
		'type' => 'heading');

// Standard Meta
	$options[] = array(
		'name' => __('Head ID', 'lunt'),
		'desc' => __("", 'lunt'),
		'id' => 'meta_headid',
		'std' => 'lunt',
		'type' => 'text');
	$options[] = array(
		'name' => __('Google Webmasters', 'lunt'),
		'desc' => __("Speaking of Google, don't forget to set your site up: <a href='http://google.com/webmasters' target='_blank'>http://google.com/webmasters</a>", 'lunt'),
		'id' => 'meta_google',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('Author Name', 'lunt'),
		'desc' => __('Populates meta author tag.', 'lunt'),
		'id' => 'meta_author',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('Mobile Viewport', 'lunt'),
		'desc' => __('Uncomment to use; use thoughtfully!', 'lunt'),
		'id' => 'meta_viewport',
...
// Icons
	$options[] = array(
		'name' => __('Site Favicon', 'lunt'),
		'desc' => __('', 'lunt'),
		'id' => 'head_favicon',
		'type' => 'upload');
	$options[] = array(
		'name' => __('Apple Touch Icon', 'lunt'),
		'desc' => __('', 'lunt'),
...
// App: Windows 8
	$options[] = array(
		'name' => __('App: Windows 8', 'lunt'),
		'desc' => __('Application Name', 'lunt'),
		'id' => 'meta_app_win_name',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'lunt'),
		'desc' => __('Tile Color', 'lunt'),
		'id' => 'meta_app_win_color',
		'std' => '',
		'type' => 'color');
	$options[] = array(
		'name' => __('', 'lunt'),
		'desc' => __('Tile Image', 'lunt'),
...
// App: Twitter
	$options[] = array(
		'name' => __('App: Twitter Card', 'lunt'),
		'desc' => __('twitter:card (summary, photo, gallery, product, app, player)', 'lunt'),
		'id' => 'meta_app_twt_card',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'lunt'),
		'desc' => __('twitter:site (@username of website)', 'lunt'),
		'id' => 'meta_app_twt_site',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'lunt'),
		'desc' => __("twitter:title (the user's Twitter ID)", 'lunt'),
		'id' => 'meta_app_twt_title',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'lunt'),
		'desc' => __('twitter:description (maximum 200 characters)', 'lunt'),
		'id' => 'meta_app_twt_description',
		'std' => '',
		'type' => 'textarea');
	$options[] = array(
		'name' => __('', 'lunt'),
		'desc' => __('twitter:url (url for the content)', 'lunt'),
		'id' => 'meta_app_twt_url',
		'std' => '',
		'type' => 'text');
...
// App: Facebook
	$options[] = array(
		'name' => __('App: Facebook', 'lunt'),
		'desc' => __('og:title', 'lunt'),
		'id' => 'meta_app_fb_title',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'lunt'),
		'desc' => __('og:description', 'lunt'),
